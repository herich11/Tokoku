            ...
            <tbody>
                ...
                <?php foreach ($this->cart->contents() as $items) : ?>
                    ...
                    <tr class="gradeX">
                        ...
                        <td>
                            <a class="btn btn-mini btn-danger btn-block delbutton" href="#" class="delbutton" id="<?php echo 'tambah/' . $items['rowid'] . '/' . $kd_penjualan . '/' . $items['id'] . '/' . $items['qty']; ?>">
        ...
        <div class="row-fluid">
            ...
            <div class="span4 badge pull-right">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="uneditable-input input-block-level" value="Rp. <?php echo $this->cart->format_number($this->cart->total()); ?>">
                    </div>
                </div>
