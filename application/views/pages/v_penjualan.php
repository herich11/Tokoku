        ...
        ?>
                <tr class="gradeX">
                    ...
                    <td>
                        ...
                        <a class="btn btn-mini" href="<?php echo site_url('cetak/print_penjualan/' . $row->kd_penjualan) ?>" onclick="print()">
                            <i class="icon-print"></i> Print</a>
                        <a class="btn btn-mini" href="<?php echo site_url('penjualan/hapus/' . $row->kd_penjualan) ?>" onclick="return confirm('Anda Yakin ?');">
