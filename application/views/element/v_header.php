                ...
                <div class="navbar-inner">
                    <div class="container">
                        <ul class="nav">
                            ...
                            <li class="<?php if (isset($active_penjualan)) {
                                            echo $active_penjualan;
                                        } ?>">
                                <a href="<?php echo site_url('penjualan') ?>"><i class="icon-barcode"></i> Penjualan</a>
                            </li>
                            <li class="<?php if (isset($active_laporan)) {
                                            echo $active_laporan;
                                        } ?>">
                                <a href="<?php echo site_url('laporan') ?>"><i class="icon-file"></i> Laporan</a>
                            </li>
                            <li class="<?php if (isset($active_master)) {
                                            echo $active_master;
                                        } ?>">
                                <a href="<?php echo site_url('master') ?>"><i class="icon-cog"></i> Data Toko</a>
                            </li>
                            <li><a href="<?php echo site_url('login/logout') ?>" style="background: #FF6347; color: #fff" ;><i class="icon-white icon-remove-sign"></i> Logout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
